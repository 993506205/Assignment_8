...
public class DBAdapter {
    ...
    private static final String DATABASE_NAME = "personInfoDB.db";
...
// This method will retrieve a particular customer
    ...
    public Cursor getContact(long rowID) {
        ...
        Cursor cursor = sqlLiteDb.query(true, TABLE_NAME, null,
                KEY_ROW_ID + "=" + rowID,
    ...
    public Cursor getPersonByFirstName(String firstname) {
